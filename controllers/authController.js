...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!token) {
    return next(
      new AppError("You are not logged in! Please log in to get ", 401)
    );
  }
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  //1) Get user based on the token , encrypted token comparision in db
  ...
  //----- middleware in file authCOntroller at line 60
